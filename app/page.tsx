  ...
  return (
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
              <Button
                size="lg"
                className="bg-primary hover:bg-primary/90 text-primary-foreground shadow-xl hover:shadow-2xl transition-all duration-300 px-8 py-4 text-lg"
              >
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-2 border-primary text-primary hover:bg-primary hover:text-primary-foreground bg-transparent shadow-lg hover:shadow-xl transition-all duration-300 px-8 py-4 text-lg"
              >
                Ver Demo en Vivo
              </Button>
            </div>
      ...
      <section id="servicios" className="py-24 bg-card relative">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="bg-background border-2 border-border hover:border-primary/50 hover:shadow-2xl transition-all duration-300 group">
              ...
              <CardContent>
                <CardDescription className="text-center text-base leading-relaxed">
                  Crea y gestiona menús digitales interactivos. Actualiza precios y disponibilidad en tiempo real con
            ...
            <Card className="bg-background border-2 border-border hover:border-primary/50 hover:shadow-2xl transition-all duration-300 group">
              ...
              <CardContent>
                <CardDescription className="text-center text-base leading-relaxed">
                  Controla tu stock, recibe alertas de productos bajos y optimiza tus compras automáticamente con IA
                  predictiva.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-background border-2 border-border hover:border-primary/50 hover:shadow-2xl transition-all duration-300 group">
              ...
              <CardContent>
                <CardDescription className="text-center text-base leading-relaxed">
                  Administra horarios, turnos y rendimiento de tu equipo desde una sola plataforma con métricas
                  avanzadas.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="bg-background border-2 border-border hover:border-primary/50 hover:shadow-2xl transition-all duration-300 group">
              ...
              <CardContent>
                <CardDescription className="text-center text-base leading-relaxed">
                  Monitorea ingresos, gastos y rentabilidad con reportes detallados y análisis predictivos en tiempo
                  real.
                </CardDescription>
              </CardContent>
            </Card>
    ...
    <FadeInSection>
      <section id="contacto" className="py-24 bg-card">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold text-foreground mb-6 text-balance">Contáctanos</h2>
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto text-pretty">
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              <h3 className="text-3xl font-bold text-foreground mb-8">Información de Contacto</h3>
            ...
            <Card className="bg-background border-2 border-border shadow-2xl">
              ...
              <CardContent className="space-y-6">
                <div className="grid grid-cols-2 gap-4">
                  <Input placeholder="Nombre" className="bg-input border-2 border-border focus:border-primary h-12" />
                  <Input placeholder="Apellido" className="bg-input border-2 border-border focus:border-primary h-12" />
                </div>
                <Input
                  placeholder="Email"
                  type="email"
                  className="bg-input border-2 border-border focus:border-primary h-12"
                />
                <Input placeholder="Teléfono" className="bg-input border-2 border-border focus:border-primary h-12" />
                <Textarea
                  placeholder="Cuéntanos sobre tu restaurante y cómo podemos ayudarte..."
                  className="bg-input border-2 border-border focus:border-primary min-h-[140px] resize-none"
                />
                <Button className="w-full bg-primary hover:bg-primary/90 text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-300 h-12 text-lg font-medium">
                  Enviar Mensaje
                </Button>
              </CardContent>
            </Card>
          ...
          <div className="grid md:grid-cols-4 gap-12">
            ...
            <div>
              ...
              <ul className="space-y-3 text-background/80">
                <li>
                  <a href="#inicio" className="hover:text-primary transition-colors text-base">
                    Inicio
                  </a>
                </li>
                <li>
                  <a href="#servicios" className="hover:text-primary transition-colors text-base">
                    Servicios
                  </a>
                </li>
                <li>
                  <a href="#nosotros" className="hover:text-primary transition-colors text-base">
                    Nosotros
                  </a>
                </li>
                <li>
                  <a href="#contacto" className="hover:text-primary transition-colors text-base">
                    Contacto
                  </a>
                </li>
              </ul>
